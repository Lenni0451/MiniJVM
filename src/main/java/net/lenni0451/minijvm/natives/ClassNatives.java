...
public class ClassNatives implements Consumer<ExecutionManager> {
    ...
    public void accept(ExecutionManager manager) {
        manager.registerNativeExecutor("java/lang/Class.registerNatives()V", MethodExecutor.NOOP_VOID);
        manager.registerNativeExecutor("java/lang/Class.desiredAssertionStatus0(Ljava/lang/Class;)Z", (executionManager, executionContext, currentClass, currentMethod, instance, arguments) -> {
        ...
        manager.registerNativeExecutor("java/lang/Class.isArray()Z", (executionManager, executionContext, currentClass, currentMethod, instance, arguments) -> {
